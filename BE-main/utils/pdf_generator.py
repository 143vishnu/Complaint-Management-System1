...
class ComplaintPDFGenerator:
    ...
    def generate_complaint_pdf(self, complaint_data):
        ...
        try:
            ...
            qr_header = Paragraph("<b>Scan to Track Status:</b>", self.header_style)
            elements.append(qr_header)
            
            # Generate QR code
            tracking_url = f"https://queriespro.vercel.app/dashboard?ticket_id={complaint_data['ticket_id']}"
            ...
            with tempfile.NamedTemporaryFile(delete=False, suffix='.png') as tmp_qr:
                ...
                temp_files.append(tmp_qr_path)
                
                qr_flowable = Image(tmp_qr_path, width=1.5*inch, height=1.5*inch)
