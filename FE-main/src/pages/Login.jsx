...
function Login() {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (userData && userData.role === 'admin') {
          // Additional keys for AdminDashboard compatibility
  ...
  return (
    <>
      ...
      {/* Show login form only when not loading and not authenticated */}
      {!authLoading && !user && (
      ...
      <div className="relative max-w-md w-full space-y-8">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 p-8">
          ...
          <div className="mt-4 text-sm text-gray-600">
            ...
            <p><strong>Student:</strong> student@example.com / password: student123</p>
            <p><strong>Faculty:</strong> faculty@example.com / password: faculty123</p>
          </div>
